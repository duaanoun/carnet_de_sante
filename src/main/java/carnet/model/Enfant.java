...
/**
 * Représente un enfant de la table Enfant.
...
public class Enfant {
    ...
    private String    nom;              // ← Colonne SQL "NomEn"
    private String    prenom;           // ← Colonne SQL "PrenomEN"
    ...
    public Enfant(int idEnfant, String nom, String prenom, LocalDate dateNaissance,
                  String sexe, String groupeSanguin, int idCarnetDeSante, int idParent) {
